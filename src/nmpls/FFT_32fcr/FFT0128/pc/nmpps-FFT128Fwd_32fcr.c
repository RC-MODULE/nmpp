...
void nmppsFFT128Fwd_32fcr(const nm32fcr *x128, nm32fcr *X128, NmppsFFTSpec_32fcr *spec128)
{
    int i;
    ...
    nmppsFFT64Fwd_32fcr(buff128, buff128, spec128);
    nmppsFFT64Fwd_32fcr(buff128xW, buff128xW, spec128);
    for(i = 0; i < 64; i++) {

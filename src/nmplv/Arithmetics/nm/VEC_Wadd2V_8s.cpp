...
void nmppsWeightedSum_Exe(nm16s* pSrcVec1,nm16s* pSrcVec2, S_nmppsWeightedSum* kerW, nm32s* pDstVec, int nSize);
// Расчёт линейной комбинации Vec1 и Vec2 по предварительно сформированной матрице с w1,w2
void nmppsWeightedSum_Exe(nm32s* pSrcVec1,nm32s* pSrcVec2, S_nmppsWeightedSum* kerW, nm64s* pDstVec, int nSize);
   //! \}
...
void nmppsWeightedSum(nm8s* pSrcVec1,int W1,nm8s* pSrcVec2,int W2, nm16s* pDstVec, int nSize)
{
	...
	nmppsWeightedSum_Set8(W1,W2,&kerW);
	nmppsWeightedSum_Exe(pSrcVec1,pSrcVec2, &kerW, pDstVec, nSize);
}

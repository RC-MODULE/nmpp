...
global _SIG_Filter__FPiPiiPl:label;
global _void._.8.8SIG_Filter.1int._.0.9._int._.0.9._int.9._long._.0.2 :label;
<_SIG_Filter__FPiPiiPl>
<_void._.8.8SIG_Filter.1int._.0.9._int._.0.9._int.9._long._.0.2>
.branch;
	ar5 = sp - 2;

...
//! \fn void VEC_Cnv(nm64s* pSrcVec, nm16s* pDstVec, int nSize)
//!
//! \perfinclude _VEC_Cnv__FPlPii.html


global _void._.8.8VEC_Cnv.1long._.0.9._short._.0.9._int.2 :label;
<_void._.8.8VEC_Cnv.1long._.0.9._short._.0.9._int.2>
.branch;

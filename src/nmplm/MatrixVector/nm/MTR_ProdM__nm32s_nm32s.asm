...
//--------------------------------------------------------------------
//! \fn void MTR_ProdM( nm32s* pSrcMtr1, int nHeight1, int nWidth1,  nm32s* pSrcMtr2, nm32s* pDstMtr, int nWidth2);
//!
//! \perfinclude _MTR_ProdM__FPiiiPiPii.html
//--------------------------------------------------------------------
...
global _MTR_ProdM__FPiiiPiPii:label;
global _void._.8.8MTR_ProdM.1int._.0.9._int.9._int.9._int._.0.9._int._.0.9._int.2 :label;
<_MTR_ProdM__FPiiiPiPii>
<_void._.8.8MTR_ProdM.1int._.0.9._int.9._int.9._int._.0.9._int._.0.9._int.2>
.branch;
	...
	gr7 = gr4>>1;
	[LongColumns] = gr7;
	gr3 = 80000000h with gr6 = gr4;			// gr3(nb1)

...
//!
//! \perfinclude _nmppsCopy__FPcPci_.html

global _void._.8.8nmppsCopy_.1char._.0.9._char._.0.9._int.2 :label;
<_void._.8.8nmppsCopy_.1char._.0.9._char._.0.9._int.2>
.branch;

...
//--------------------------------------------------------------------
//! \fn void MTR_ProdM( nm8s* pSrcMtr1, int nHeight1, int nWidth1,  nm32s* pSrcMtr2, nm32s* pDstMtr, int nWidth2)
//!
//! \perfinclude _MTR_ProdM__FPciiPiPii.html
//--------------------------------------------------------------------
...
global _void._.8.8MTR_ProdM.1char._.0.9._int.9._int.9._int._.0.9._int._.0.9._int.2 :label;
<_MTR_ProdM__FPciiPiPii>
<_void._.8.8MTR_ProdM.1char._.0.9._int.9._int.9._int._.0.9._int._.0.9._int.2>
.branch;

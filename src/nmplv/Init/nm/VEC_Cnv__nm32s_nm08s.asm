...
//! \fn void VEC_Cnv(nm32s* pSrcVec, nm8s* pDstVec, int nSize);
//!
//! \perfinclude _VEC_Cnv__FPiPci.html

global _void._.8.8VEC_Cnv.1int._.0.9._char._.0.9._int.2 :label;
<_void._.8.8VEC_Cnv.1int._.0.9._char._.0.9._int.2>
.branch;

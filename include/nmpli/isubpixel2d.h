...
//class I_2DSubPixelMinPosition предназначен дл¤ поиска субпиксельного минимума в массиве 3x3.
//»меютс¤ две реализации - "параболическа¤" и "тригонометрическа¤"
...
//“ип реализации ("параболическа¤" и "тригонометрическа¤" соответственно)

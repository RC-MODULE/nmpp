...
//--------------------------------------------------------------------
//! \fn int VEC_MinPosV256(int* pSrcVec,int nStride,int& nPos);
//!
//! \perfinclude _VEC_MinPosV256__FPiiRi.html
//--------------------------------------------------------------------

global _VEC_MinPosV256__FPiiRi:label;
global _int._.8.8VEC_MinPosV256.1int._.0.9._int.9._int._.6.2 :label;
<_VEC_MinPosV256__FPiiRi>
<_int._.8.8VEC_MinPosV256.1int._.0.9._int.9._int._.6.2>
.branch;

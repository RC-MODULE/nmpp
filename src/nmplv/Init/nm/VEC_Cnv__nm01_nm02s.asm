...
//! \fn void nmppsCnv_1*(nm1* pSrcVec, nm2s* pDstVec, int nSize)
//!
//! \perfinclude _nmppsCnv__F3nm1P4nm2sPi_.html


global _void._.8.8nmppsCnv_.1class._nm1._.0.9._class._nm2s._.0.9._int.2 :label;
<_void._.8.8nmppsCnv_.1class._nm1._.0.9._class._nm2s._.0.9._int.2>
.branch;
	ar5 = ar7 - 2;
	push ar0, gr0;
	push ar1, gr1;

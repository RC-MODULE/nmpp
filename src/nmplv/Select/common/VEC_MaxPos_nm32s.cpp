...
//! 
void nmppsMaxIndx_32s(nm32s31b *pSrcVec, int nSize, int& nIndex, int32b &nMaxValue, void *pLTmpBuff,void *pGTmpBuff, int nSearchDir)
{
	int nPos;
	void* pTmp1;
	void* pTmp2;
	...
	nmppsMax_32s(pSrcVec, nSize, &nMaxValue);

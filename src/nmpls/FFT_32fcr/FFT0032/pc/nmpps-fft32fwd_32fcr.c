...
void nmppsFFT32Fwd_32fcr(const nm32fcr *x32, nm32fcr *X32, NmppsFFTSpec_32fcr *spec32)
{
    int i;
    ...
    nmppsFFT16Fwd_32fcr(buff32, buff32, spec32);
    nmppsFFT16Fwd_32fcr(buff32xW, buff32xW, spec32);
    for(i = 0; i < 16; i++) {

...
//! \fn void VEC_Neg (nm8s *pSrcVec, nm8s *pDstVec, int nSize) 
//!
//! \perfinclude _VEC_Neg__FPcPci.html

global _VEC_Neg__FPcPci:label;
global _void._.8.8VEC_Neg.1char._.0.9._char._.0.9._int.2 :label;
<_VEC_Neg__FPcPci>
<_void._.8.8VEC_Neg.1char._.0.9._char._.0.9._int.2>
.branch;

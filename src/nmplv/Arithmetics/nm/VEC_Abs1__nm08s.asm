...
//! \fn void VEC_Abs1 (nm8s *pSrcVec, nm8s *pDstVec, int nSize) 
//!
//! \perfinclude _VEC_Abs1__FPcPci.html

global _VEC_Abs1__FPcPci:label;
global _void._.8.8VEC_Abs1.1char._.0.9._char._.0.9._int.2 :label;
<_VEC_Abs1__FPcPci>
<_void._.8.8VEC_Abs1.1char._.0.9._char._.0.9._int.2>
.branch;

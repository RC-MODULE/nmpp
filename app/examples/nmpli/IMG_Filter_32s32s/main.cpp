...
int main()
{
	...
	unsigned crc=0;
	C_WarpImg<nm32s> SrcImg(176/2,144/2,2,malloc32,free32);
	C_WarpImg<nm32s> DstImg(176/2,144/2,0,malloc32,free32);
	
	if (SrcImg.pWarp==0 || DstImg.pWarp==0)
		return -1;

	nmppsRandUniform_(SrcImg.pWarp, SrcImg.nWarpSize);
	CnmppiFIR<nm32s,nm32s> FIR(wker,hker,malloc32,free32);

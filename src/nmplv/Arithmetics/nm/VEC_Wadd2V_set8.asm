...
//! \brief  <Установка двух к-тов для VEC_WAdd2V_Exe(nm8s...>
//!
//! \endif
//!
//------------------------------------------------------------------------
...
global _void._.8.8VEC_WAdd2V_Set8.1int.9._int.9._class._S_VEC_WAdd2V._.0.2 :label;

<_void._.8.8VEC_WAdd2V_Set8.1int.9._int.9._class._S_VEC_WAdd2V._.0.2>
  ar5=ar7-2;
  push ar0,gr0;

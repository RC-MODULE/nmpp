...
void nmppsFFT16Fwd_32fcr(const nm32fcr *x16, nm32fcr *X16, NmppsFFTSpec_32fcr *spec16)
{
    int i = 0;
    ...
    nmppsDFT8Fwd_32fcr(buff8, buff8, spec16);
    nmppsDFT8Fwd_32fcr(buff8xW, buff8xW, spec16);
    for(i = 0; i < 8; i++) {

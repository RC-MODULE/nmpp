...
//! \brief  Вычитание массива SRC из массива результата.
//!
//! \endif
//!
//------------------------------------------------------------------------
...
<with_remainder>
    ...
    gr5=9c50181ch with gr7=gr7 or gr3;//rep 1 data=[ar1++]with data-afifo
...
<CC> rep 1 data=[ar0++] with data;         // 9c101518
     rep 1 data=[ar1++] with data-afifo;   // 9c50181c

...
begin ".text_nmpls"
    ...
    //--------------------------------------------------------------------
    //! \fn void SSIG_Filter(nm8s* pSrcVec, nm16s* pDstVec, int nSize, nm64s* pKernel)
	//!
	// \perfinclude _SSIG_Filter__FPcPSsiPl.html
    //--------------------------------------------------------------------
extern vec_ClipMulNDNW8_AddVr:label;
extern vec_Mul2D2W8_AddVr:label;

global _SIG_Filter__FPcPSsiPl:label;
global _void._.8.8SIG_Filter.1char._.0.9._short._.0.9._int.9._long._.0.2 :label;
<_SIG_Filter__FPcPSsiPl>
<_void._.8.8SIG_Filter.1char._.0.9._short._.0.9._int.9._long._.0.2>
.branch;
	ar5 = sp - 2;

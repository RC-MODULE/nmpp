...
\ingroup Floodfill
	...
	\param spot 
		...
		\b Замечание1. Чтобы гарантированно избежать переполнения массива spot в общем случае (когда характер матрицы, количество, размер пятен неизвестны, и не задан
		\verbatim 
		параметр mSpot>0), размер массива spot в 32-битных словах должен быть:
